module utilities
  ...
  !*****************************************************************************
   pure elemental integer function yearfromjd (jd)
    ! a partial inverse of the jd function above

     implicit none
     integer, intent(in) :: jd

      yearfromjd = (400*jd + 277571997.0)/146097 + 0.08333333334

   end function yearfromjd
